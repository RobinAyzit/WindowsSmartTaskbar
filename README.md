...
3.  **Manage Your List**: Drag programs to reorder or right-click to change categories.
4.  **System Tray**: Single-click for Quick Launch; Double-click for the main window.
